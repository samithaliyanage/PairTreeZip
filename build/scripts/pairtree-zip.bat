...
@rem ##########################################################################
@rem
@rem  pairtree-zip startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and PAIRTREE_ZIP_OPTS to pass JVM options to this script.
...
:fail
rem Set variable PAIRTREE_ZIP_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%PAIRTREE_ZIP_EXIT_CONSOLE%" exit 1
exit /b 1
